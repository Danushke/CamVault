...
import com.desirecodes.mycamapp.Constant.FILE_NAME_FORMAT
...
class CameraService : LifecycleService() {
    ...
    private fun getCustomDirectory(): File {
        ...
        // Create .nomedia file to ensure it's hidden from media scanners
    ...
    private fun startVideoRecording() {
        ...
        val videoFile = File(getCustomDirectory(), fileName)
